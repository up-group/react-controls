...
General.decorators = [(General) => <div style={{ padding: "30px", height: 200 }}><General /></div>];
                    ...
                    <UpRadio
                        ...
                        options={
                            [
                                ...
                                { text: "Option 2", value: "option2", iconName: 'cake' },
                                { text: "Option 3", value: "option3", iconName: 'cocktail' }
                            ]
                        }
                    />
                </div>
...
export const DisplayWithToggledElement =
    () => (
        <UpRadio
            ...
            options={
                [
                    { text: "Option 1", value: "option1", toggledElement: <UpInput placeholder={"Saisir votre message"} /> },
                    { text: "Option 2", value: "option2", toggledElement: <UpNumber /> },
                    { text: "Option 3", value: "option3", toggledElement: <UpCheckBox options={[{ name: "case", text: "Cocher la case suivante" }]} /> }
                ]
            } />
    );
