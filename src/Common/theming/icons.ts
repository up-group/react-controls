...
| 'colored-calendar' | 'colored-transaction' | 'colored-equalizer' | 'colored-card' | 'colored-card-inclined' | 'colored-list' | 'colored-summary' | 'pen' | 'bill-sheet' | 'copy' | 'duplicate' | 'file2' | 'home' | 'up-password'
| 'condition' |'on-off'
...
'spoon', 'stack', 'star-filled','star-outline','step-back', 'step-forward',
'switch-off', 'switch-on', 'tag', 'thumb', 'timer', 'top-aligned-text', 'trash-can', 'tv', 'fax', 'load-file', 'video-camera',
