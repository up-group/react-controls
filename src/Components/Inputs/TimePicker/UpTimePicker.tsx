...
export default class UpTimePicker extends React.Component<UpTimeProps, UpTimeState> {
  ...
  render() {
    ...
    return (
      <>
        <UpBox
          className={classnames(wrapperStyles, 'up-timepicker up-form-control')}
          flexDirection={'row'}
        ...
        <UpContextMenu id={this.minuteContextMenuId}>
          {minuteSteps.map((step, i) => {
            return (
              <UpContextMenuItem key={i} onClick={this.setMinute} data={{ value: step }}>
                {step}
              </UpContextMenuItem>
            );
          })}
        ...
        <UpContextMenu id={this.hourContextMenuId}>
          {hourSteps.map((step, i) => {
            return (
              <UpContextMenuItem key={i} onClick={this.setHour} data={{ value: step }}>
                {step}
              </UpContextMenuItem>
            );
          })}
  ...
  onchangeHourEvent = e => {
    this.onchangeHour(e.target.value);
  };
  onchangeHour = value => {
  ...
  onchangeMinEvent = e => {
    this.onchangeMin(e.target.value);
  };
  onchangeMin = value => {
