...
const BaseRadioButton: React.FunctionComponent<UpRadioStyledProps & WithThemeProps> = (
  props: UpRadioStyledProps & WithThemeProps
) => {
  const {
    checked,
    iconName,
  ...
  return (
    <>
      ...
      >
        ...
        />
        <span
          className={`up-control-wrapper ${
            isTextArray ? 'up-control-wrapper--adaptive-height' : 'up-control-wrapper--fixed-height'
          }`}
        >
          <span className="up-control-indicator"></span>
        </span>
        <span
          className={`up-control-text ${
            isTextArray ? 'up-control-text--adaptive-height' : 'up-control-text--fixed-height'
          }`}
        >
