...
export const getPictureCustomStyle = (
  key: UpPictureCustomStylesKeys,
  customStyles: UpPictureCustomStyles,
  props: Partial<UpPictureProps>,
  state?: UpPictureState
) => {
  return getCustomStyles<UpPictureCustomStylesKeys, Partial<UpPictureProps>, UpPictureState>(
    key,
    customStyles,
    props,
    state
