...
describe('Tests for UpVerticalTimeline', () => {
  it('should render global title in div tag', () => {
    renderComponent(<UpVerticalTimeline title={'Suivi de commandes'} timeline={timeLine} />);
  ...
  it('should render expected graphic events timeLine', () => {
    const { container } = renderComponent(<UpVerticalTimeline title={'Suivi de commandes'} timeline={timeLine} />);
