...
export const GeneralUse = () => <UpPanel type={'default'} title={'Mon Panel'} message={'Mon panel text'} />;

export const customedTitle = () => (
  <UpPanel
    type={'danger'}
    title={<h3 style={{ borderBottom: '1px dotted white' }}>Mon JSX Panel</h3>}
    message={'Mon panel text'}
  />
);

export const WithFooter = () => (
  <UpPanel type={'info'} title={'Mon Panel'} message={'Mon panel text'} footer={'this is the footer'} />
);

export const WithIcon = () => <UpPanel type={'success'} title={'Mon Panel'} message={'Success'} iconName={'delete'} />;
