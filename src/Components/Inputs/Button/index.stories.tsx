...
import UpButton, { UpButton as UpButtonComponent } from './UpButton';
...
const codeStoryADroite = `const actions = [{libelle: "Option 1", onClick: action("Option 1")}, {libelle: "Option 2", onClick: action("Option 2")},{size: 2,},{libelle: "Option 3",onClick: action("Option 3")}];
        <UpButton 
        intent="primary" 
      ...
      <UpBox flexDirection={'column'} alignItems={'flex-start'} style={{ margin: '40px 30px' }}>
        ...
        <UpNotification intent={'info'}>
          <UpBox flexDirection={'column'}>
            ...
            <ul style={{ margin: '8px' }}>
              <li>actionType : Le type de l'action gérer par le bouton. Exemple 'add' ajoutera un icône approprié.</li>
              <li>intent : le type du bouton : 'primary', 'secondary', 'info', 'success', 'warning' ou 'error'</li>
              <li>onClick : l'action a exécuté.</li>
            </ul>
          </UpBox>
        </UpNotification>
        <UpParagraph>
...
export const DropDownWithText = () => (
  <UpThemeProvider theme={UpDefaultTheme}>
    <UpBox flexDirection={'column'} alignItems={'flex-start'} style={{ margin: '40px 30px' }}>
      ...
      <UpNotification intent={'info'}>
        <UpParagraph>
          Le composant <code>UpButton</code> en définissant un menu d'actions associées et un label principal et l'icône
          à gauche.
        </UpParagraph>
      </UpNotification>
      <UpParagraph>
