...
export const General = () => (
  <>
    <UpParagraph paragraphSize={'xlarge'} margin={'none'} textAlign={'left'} className={paragraphStyle}>
      Paragraph in XLarge Text Size And no Margin
    </UpParagraph>
    <UpParagraph paragraphSize={'large'} margin={'small'} textAlign={'center'} className={paragraphStyle}>
      Centred Paragraph, in large Text Size And small Margin
    </UpParagraph>
    <UpParagraph paragraphSize={'medium'} margin={'medium'} textAlign={'right'} className={paragraphStyle}>
