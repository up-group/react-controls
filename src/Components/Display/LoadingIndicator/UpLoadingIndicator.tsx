...
class LoadingIndicator extends React.Component<LoadingIndicatorProps & WithThemeProps>{
    ...
    render() {
        ...
        if (_displayMode === "zone") {
            ...
            return (
                <Box boxSize={"auto"} pad={"none"} margin={'none'} alignItems="center" justifyContent="center" className={classnames('up-loading-indicator', this.props.className)}>
                                        ...
                                        <UpRow>
                                            <UpCol span={24}>
                                                <p className="loading-status text-info"
                                                    style={{ "textAlign": "left", color: theme.colorMap.grey1 }}>
                                                    {this.props.message}
                                                </p>
                                            </UpCol>
                                        </UpRow>
