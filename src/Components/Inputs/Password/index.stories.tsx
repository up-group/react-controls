...
WithRules.decorators = [(WithRules) => <div style={{ padding: '30px' }}><WithRules /></div>];
...
PasswordWithFloatingLabel.decorators = [(PasswordWithFloatingLabel) => <div style={{ padding: '30px' }}><PasswordWithFloatingLabel /></div>];
