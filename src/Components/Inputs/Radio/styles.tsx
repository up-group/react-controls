  ...
  return {
    $nest: {
      ...
      '&.upContainer__groupradio-horizontal label.up-radio': {
        marginRight: `${props.gutter ? toRem(props.gutter) : 0}`,
        marginBottom: `${props.gutter ? toRem(props.gutter) : 0}`,
        width: props.nbItemsPerRow
          ? `${Math.floor(100 / props.nbItemsPerRow) - Math.ceil((props.gutter ?? 0) / 16)}%`
          : 'auto',
      },
      ...
      '&.upContainer__groupradio-vertical label.up-radio': {
        marginTop: `${props.gutter ? toRem(props.gutter) : 0}`,
        cursor: props.readonly && 'unset',
      },
      '&.upContainer__groupradio-button.upContainer__groupradio-horizontal label.up-radio': {
        marginLeft: `${props.gutter ? toRem(props.gutter) : 0}`,
        cursor: props.readonly && 'unset',
      },
      ...
      '&.upContainer__groupradio-large .up-control-text': {
        ...
        borderTopRightRadius: toRem(4),
        borderLeftWidth: toRem(0),
