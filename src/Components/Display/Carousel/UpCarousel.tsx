  ...
  return (
    <motion.li
      ...
      className={classnames(
        'up-carousel-item',
        style({
          ...getItemStyles({ customStyles }, currentItem, item),
          ...getCustomStyle('item', { customStyles }, currentItem, item),
        })
      )}
      {...props}
      {...handlers}
  ...
  return (
    <ul
      className={classnames(
        'up-carousel',
        style({
          ...getListStyles(props, currentItem),
          ...getCustomStyle('list', props, currentItem),
        })
      )}
    >
      {props.items &&
