...
import UpDataGridHeader from './UpDataGridHeader';
...
// Typescript
import { SortDirection, Row, Column, UpDataGridState, UpDataGridProps } from './model/index';

// Style
import { WrapperDataGridStyle, DataGridStyle } from './style/UpDataGrid.style';
...
class UpDataGrid extends React.Component<UpDataGridProps & WithThemeProps, UpDataGridState> {
  ...
  constructor(props) {
    super(props);
    const data = props.data as Array<Row>;
  ...
  handleData = (data: Array<Row>): void => {
