...
export const RadioGroupStyles = (props: RadioGroupProps & WithThemeProps) => {
  return {
    $nest : {
      ...
      '&.upContainer__groupradio-large .up-control-text svg,&.upContainer__groupradio-large .up-control-text svg path, &.upContainer__groupradio-large .up-control-text svg polygon' : {
        color: '#4e5b59',
      },
