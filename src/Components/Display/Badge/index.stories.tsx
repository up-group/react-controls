...
export const General =
    () => (
        <>
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>primary</b></UpLigne>
                <UpBadge
                    text='1'
                    rounded={true}
                    intent='primary'
            ...
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>info</b></UpLigne>
                <UpBadge
                    text='2'
                    rounded={true}
                    intent='info'
            ...
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>default</b></UpLigne>
                <UpBadge
                    text='3'
                    rounded={true}
                    intent='default'
            ...
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>warning</b></UpLigne>
                <UpBadge
                    text='4'
                    rounded={true}
                    intent='warning'
            ...
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>danger</b></UpLigne>
                <UpBadge
                    text='5'
                    rounded={true}
                    intent='danger'
            ...
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>error</b></UpLigne>
                <UpBadge
                    text='6'
                    rounded={true}
                    intent='error'
            ...
            <UpBox margin={'small'}>
                <UpLigne color={'#000'}>Badge <b>intent</b> is <b>light</b></UpLigne>
                <UpBadge
                    text='7'
                    rounded={true}
                    intent='light'
...
export const ColorBackgroundProperties =
    () => (
        <UpBox margin={'small'}>
            <UpLigne color={'#000'}>Set Badge <b>background</b> and <b>color</b></UpLigne>
            <UpBadge
                text='1'
                rounded={true}
                background='yellow'
