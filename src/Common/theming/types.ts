...
export type CustomStyles<K extends string | number | symbol, P, S> = {
  [key in K]?: GetterStyle<P, S>;
};

export function getCustomStyles<K extends string | number | symbol, P, S>(
  key: K,
  customStyles: CustomStyles<K, P, S>,
  props: P,
  state?: S
): NestedCSSProperties {
