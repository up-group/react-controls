...
export const RequiredMark = ({ markStyle }) => (
    <UpLigne
...
const BaseInput: React.FunctionComponent<UpInputStyledProps & WithThemeProps & UpInputProps> = (props: UpInputStyledProps & WithThemeProps & UpInputProps) => {
