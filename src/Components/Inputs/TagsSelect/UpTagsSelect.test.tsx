...
const create = () => render(<UpTagsSelect {...props} />);
afterEach(cleanup);
...
describe("TagsSelect", () => {
    ...
    it("should call the onChange prop when one of the tags is clicked", () => {
        ...
        expect(onChange)
            .toHaveBeenCalledWith(expect.anything(), [{id: '1', text: 'Mono', selected: true}, {id: '2', text: 'Multi', selected: false}]);

        fireEvent.click(tag1);
        expect(onChange)
            .toHaveBeenCalledWith(expect.anything(), [{id: '1', text: 'Mono', selected: false}, {id: '2', text: 'Multi', selected: false}]);
