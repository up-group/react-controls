    ...
    return {
        $nest: {
            '&.up-btn': {
                ...
                paddingBottom: 0,
                paddingTop: 0,
                paddingLeft: props.width === 'icon' ? 0 : (props.iconName != null || props.actionType != null) && props.iconPosition === 'left' ? toRem(32) : toRem(6),
                paddingRight: props.width === 'icon' ? 0 : (props.iconName != null || props.actionType != null) && props.iconPosition === 'right' ? toRem(32) : toRem(6),
                textDecoration: 'none',
                display: 'flex',
