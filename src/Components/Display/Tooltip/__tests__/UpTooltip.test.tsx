...
describe('Tests for UpTooltip', () => {
  it('should render Tooltip component', () => {
    const { container } = renderComponent(
      <UpTooltip content={'MyTooltip'}>
        <UpLigne>UpTooltip</UpLigne>
      </UpTooltip>
    );
  ...
  it('should render function chidren as element', () => {
    renderComponent(
      <UpTooltip content={'MyTooltip'}>
        {({ id }) => (
          <UpLigne data-for={id} data-tip="tooltip">
            UpTooltip
          </UpLigne>
        )}
      </UpTooltip>
  ...
  it('should render children without Tooltip data attributes if invalid Element', () => {
    renderComponent(<UpTooltip content={'MyTooltip'}>UpTooltip</UpTooltip>);
