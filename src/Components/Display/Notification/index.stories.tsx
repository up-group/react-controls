...
const useShowButton = () => {
  ...
  const Button = (
    <UpButton intent={'primary'} onClick={() => setKey(key + 1)}>
      Show Notification
    </UpButton>
  );
...
export const General = () => (
  <UpBox alignItems={'normal'} className={wrapperBoxesStyle}>
...
export const WithBigIcon = () => (
  <UpNotification intent="success" iconSize={40}>
    <UpLine>Votre opération a été enregistré avec succès !</UpLine>
  </UpNotification>
);

export const ShowInModal = () => (
  <UpNotification title={'Erreur'} displayMode={'modal'} intent="danger">
    <p>Un problème est survenu !!</p>
  </UpNotification>
);

ShowInModal.decorators = [
  ShowInModal => (
...
export const ShowInText = () => (
  <UpNotification displayMode={'text'} intent="danger">
