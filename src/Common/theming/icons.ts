...
| 'colored-calendar' | 'colored-transaction' | 'colored-equalizer' | 'colored-card' | 'colored-card-inclined' | 'colored-list' | 'colored-summary' | 'pen' | 'bill-sheet' | 'copy' | 'duplicate' | 'password'
