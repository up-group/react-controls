...
const index_1 = require("../../Display/SvgIcon/index");
...
.up-input-group {
  ...
  .up-input-group.up-intent-danger .up-icon {
    ...
    .up-dark .up-input-group.up-intent-danger .up-icon {
      color: #ff7373; }
`;
const HeightLarge = styled_components_1.css `
  height: 40px;
  line-height: 40px;
  font-size: 16px;
  padding: 0 15px; 
`;
const error = styled_components_1.css `
.up-input {
...
`;
exports.InputStyled = styled_components_1.default(BaseInput) `
  ${inputStyles}
  ${(props) => props.hasError ? error : styled_components_1.css ``}
  color: ${(props) => props.color};
  .up-input {
    width: ${(props) => maps_1.sizeMap[props.width]};
    ${(props) => (props.height == "large" ? HeightLarge : styled_components_1.css ``)}
  }
`;
