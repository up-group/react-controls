...
const getStyles = (props: UpDateProps & WithThemeProps & { focused: boolean }) => style({
    ...
    $nest: {
        ...
        "& .SingleDatePickerInput_calendarIcon": {
            margin: props.theme.inputBorderLess ? `0 ${props.iconPosition === "left" ? toRem(5) : toRem(0)} 0 0` : `0 ${toRem(5)} 0 ${toRem(10)}`,
            padding: toRem(4),
            position: 'absolute',
            right: 0,
            top: toRem(2)
