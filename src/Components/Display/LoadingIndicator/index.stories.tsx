...
export const General = () => <UpLoadingIndicator isLoading={true} message="Chargement en cours"></UpLoadingIndicator>;
...
export const Modal = () => (
  <div style={styles.main}>
    ...
    <p>
      ...
      <br />
      Have a look at the{' '}
      <a style={styles.link} href="https://github.com/storybooks/storybook" target="_blank" rel="noreferrer">
        Storybook
      </a>{' '}
    ...
    <p style={styles.note}>
      <b>NOTE:</b>
      <br />
      Have a look at the <code style={styles.code}>.storybook/webpack.config.js</code> to add webpack loaders and
      plugins you are using in this project.
    </p>
  </div>
);
