...
export const General = (props: { text: string; label: string; inline: boolean; textAlign: Align }) => {
  ...
  return (
    <UpLabel textAlign={props.textAlign} inline={props.inline} width="medium" text={props.label}>
      <UpCheckbox
        options={[
          {
            text: props.text,
...
export const DynamicCheckBoxesOptions = () => {
  ...
  const handleToggle = (cbName, checked) => {
    ...
    setOptions(prevOptions =>
      prevOptions.map((option: iCbOption) => {
...
DynamicCheckBoxesOptions.decorators = [
