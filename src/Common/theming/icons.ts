...
| 'acceptation' | 'check' | 'billing' | 'page' | 'circle-plus' | 'circle-close' | 'circle-info' | 'file' | 'enter' | 'profile2' | 'burger-menu2' | 'mobile-up' | 'delivery' | 'parcel' | 'bill-sheet'
| 'colored-calendar' | 'colored-piggy-bank' | 'colored-equalizer' | 'colored-list'
