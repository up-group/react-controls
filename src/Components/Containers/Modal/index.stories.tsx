...
const ModalWrapper: React.FunctionComponent<UpModalWrapperProps> = props => {
  ...
  const openModalButton = () => (
    <UpButton intent={'secondary'} actionType={'confirm'} onClick={openModal}>
      Open
    </UpButton>
  );
...
export const GeneralUse = () => <ModalWrapper />;

export const WithFooter = () => (
  <ModalWrapper
    footer={
      <UpBox justifyContent={'center'} backgroundColor={'#fff'} pad={'small'}>
        <UpButton intent={'secondary'} actionType={'confirm'}>
          Button
        </UpButton>
      </UpBox>
    }
...
export const WithHtmlContent = () => <ModalWrapper html={htmlFrame} />;

export const showFromTop = () => <ModalWrapper displayMode="fromTop" modalWidth="full" />;

export const showFromBottom = () => <ModalWrapper displayMode="fromBottom" modalWidth="full" />;

export const showFromRight = () => <ModalWrapper displayMode="fromRight" modalWidth="half" />;

export const showFromLeft = () => <ModalWrapper displayMode="fromLeft" modalWidth="half" />;

export const displayInCenter = () => <ModalWrapper screenPosition="center" />;
